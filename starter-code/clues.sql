...
SELECT continent, region, population FROM country WHERE region = 'Southern Europe' ORDER BY population ASC;
...
SELECT countrycode, percentage FROM countrylanguage WHERE language = 'Italian' ORDER BY percentage DESC;
...
SELECT continent, country.capital FROM country WHERE code = 'BRA';
